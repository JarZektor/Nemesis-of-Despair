...
player_move_right = [
    ...
    pygame.image.load('images/player/move right/1r.png'),  # 3
    pygame.image.load('images/player/move right/1r.png'),  # 4
    pygame.image.load('images/player/move right/2r.png'),  # 5
    pygame.image.load('images/player/move right/2r.png'),  # 6
    pygame.image.load('images/player/move right/2r.png'),  # 7
    pygame.image.load('images/player/move right/2r.png'),  # 8
    pygame.image.load('images/player/move right/3r.png'),  # 9
    pygame.image.load('images/player/move right/3r.png'),  # 10
    pygame.image.load('images/player/move right/3r.png'),  # 11
    pygame.image.load('images/player/move right/3r.png'),  # 12
    pygame.image.load('images/player/move right/4r.png'),  # 13
    pygame.image.load('images/player/move right/4r.png'),  # 14
    pygame.image.load('images/player/move right/4r.png')  # 15
]
player_move_left = [
    pygame.image.load('images/player/move left/1l.png'),  # 1
    pygame.image.load('images/player/move left/1l.png'),  # 2
    pygame.image.load('images/player/move left/1l.png'),  # 3
    pygame.image.load('images/player/move left/1l.png'),  # 4
    pygame.image.load('images/player/move left/2l.png'),  # 5
    pygame.image.load('images/player/move left/2l.png'),  # 6
    pygame.image.load('images/player/move left/2l.png'),  # 7
    pygame.image.load('images/player/move left/2l.png'),  # 8
    pygame.image.load('images/player/move left/3l.png'),  # 9
    pygame.image.load('images/player/move left/3l.png'),  # 10
    pygame.image.load('images/player/move left/3l.png'),  # 11
    pygame.image.load('images/player/move left/3l.png'),  # 12
    pygame.image.load('images/player/move left/4l.png'),  # 13
    pygame.image.load('images/player/move left/4l.png'),  # 14
    pygame.image.load('images/player/move left/4l.png')  # 15
]
player_idle = [
    pygame.image.load('images/player/move left/1l.png'),  # 1
    pygame.image.load('images/player/move left/1l.png'),  # 2
    pygame.image.load('images/player/move left/1l.png'),  # 3
    pygame.image.load('images/player/move left/1l.png'),  # 4
    pygame.image.load('images/player/move left/1l.png'),  # 5
    pygame.image.load('images/player/move left/1l.png'),  # 6
    pygame.image.load('images/player/move left/1l.png'),  # 7
    pygame.image.load('images/player/move left/1l.png'),  # 8
    pygame.image.load('images/player/move left/1l.png'),  # 9
    pygame.image.load('images/player/move left/1l.png'),  # 10
    pygame.image.load('images/player/move left/1l.png'),  # 11
    pygame.image.load('images/player/move left/1l.png'),  # 12
    pygame.image.load('images/player/move left/1l.png'),  # 13
    pygame.image.load('images/player/move left/1l.png'),  # 14
    pygame.image.load('images/player/move left/1l.png')  # 15
]
steam = [
